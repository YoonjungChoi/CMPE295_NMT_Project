...
onmt-main --config koen.yaml --auto_config --checkpoint_path run/baseline/avg/ckpt-210000 infer --features_file ../../data/test.tok.ko --predictions_file pred.tok.en
echo ':: End ::'
